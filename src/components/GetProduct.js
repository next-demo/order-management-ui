...
const MyProduct = props => (
    ...
    <tr className="table-info">
      ...
      {/* <td>
        <Link to={"/editmyproduct/" + props.myproduct.myproductNumber}>
          <img src={editIcon} alt="edit icon" />
        </Link>
        &nbsp; &nbsp; &nbsp;
        <Link to={"/deletemyproduct" + props.myproduct.myproductNumber}>
          <img src={deleteIcon} alt="delete icon" />
        </Link>
      </td> */}
      {/* <td>{new Date(props.myproduct.createdAt).toLocaleDateString("en-GB")}</td>
      <td>{new Date(props.myproduct.updatedAt).toLocaleDateString("en-GB")}</td> */}
    </tr>
  );
